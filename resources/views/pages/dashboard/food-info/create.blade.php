...
@section('content')
  <div class="col-12 col-lg-8 mx-auto">
    <form id="form-info" action="{{ route('dashboard.food-info.store') }}" method="POST" class="card my-5"
      enctype="multipart/form-data">
      <div class="card-header border-bottom">
        <h5 class="mb-0">
          <i class="ri-add-line"></i>
          <span class="fw-bold">Tambah Info</span>
        </h5>
      </div>
      <div class="card-body">
        <div class="row g-3">
          <div class="col-12">
            <div class="mb-3">
              ...
              <input class="form-control @error('name') is-invalid @enderror rounded-0" name="name"
                value="{{ old('name') }}" id="name" placeholder="Food Info" type="text" required>
              @error('name')

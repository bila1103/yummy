<section class="healthy-dishes-section py-4">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="section-title mb-0">Sajian Sehat Ala Yummy!</h2>
            <a href="{{ route('kategori', 'makanan-sehat') }}" class="view-all text-decoration-none">Lihat Semua <i class="ri ri-arrow-right-line"></i></a>
        </div>

        <div class="splide healthy-dishes-slider">
            <div class="splide__track">
                <ul class="splide__list">
                    @foreach($healthyDishes as $dish)
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Splide('.healthy-dishes-slider', {
            perPage: 4,
            perMove: 1,
            gap: 20,
            pagination: false,
